...
const Quiz21 = () => {
  ...
  const questions = [
    {
      id: 1,
      question: 'In Object Oriented Programming, we work around:',
      options: [
        "Classes", "main function",  "Objects", "integers"
      ],
      correctAnswer: "Objects",
    },
    {
      id: 2,
      question: 'Objects have:',
      options: [
        "properties", "behavior", "attributes" , "All are correct" 
      ],
      correctAnswer: "All are correct",
    },
    {
      id: 3,
      question: 'Objects are instances of class:',
      options: ["Yes", "No"],
      correctAnswer: "Yes",
    },
    {
      id: 4,
      question: 'Class is a:',
      options: ["Template", "user-defined data type", "blueprint", "All are correct"],
      correctAnswer: "All are correct",
    },
    {
      id: 5,
      question: 'DRY is acronym for "Donot Repeat yourself:',
      options: ["Yes", "No"],
      correctAnswer: "Yes",
    },
        ...
        <div class="container">
          <div className="ch-content">
            ...
            <div class="main-body ui segment">
              ...
              <span class="tut-btn"><Link to="/tutorials/Chapter19">
