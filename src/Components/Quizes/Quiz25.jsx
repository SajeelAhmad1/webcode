...
const Quiz25 = () => {
  ...
  const questions = [
    {
      id: 1,
      question: 'What is the main feature of friend function and friend class:',
      options: [
        "access public members", "access protected members",  "are friends of anyone", "access private members"
      ],
      correctAnswer: "access private members",
    },
    {
      id: 2,
      question: 'Friend function declared in a class is the member of that class :',
      options: [
        "Yes", "No" 
      ],
      correctAnswer: "No",
    ...
    {
      id: 3,
      question: 'Friend relationship between two classes is irreversible:',
      options: ["Yes", "No"],
      correctAnswer: "Yes",
    },
    {
        id: 4,
        question: 'Friend functions are:',
        options: ["private", "protected", "public", "can be any"],
        correctAnswer: "can be any",
      },
        ...
        <div class="container">
          <div className="ch-content">
            ...
            <div class="main-body ui segment">
              ...
              <span class="tut-btn"><Link to="/tutorials/Chapter23">
