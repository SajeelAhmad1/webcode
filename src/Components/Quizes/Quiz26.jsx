...
const Quiz26 = () => {
  ...
  const questions = [
    {
      id: 1,
      question: 'Encapsulation is the:',
      options: [
        "availability of data", "private data",  "inheriting attributes", "wrapping up of data"
      ],
      correctAnswer: "wrapping up of data",
    },
    {
      id: 2,
      question: 'Private data members are usually accessed through :',
      options: [
    ...
    {
      id: 3,
      question: 'Fully encapsulated class has all its data members:',
      options: ["public", "private", "valued", "protected"],
      correctAnswer: "private",
    },
    {
        id: 4,
        question: 'Encapsulation guarantees:',
        options: ["security", "hiding data", "protection", "All are true"],
        ...
        <div class="container">
          <div className="ch-content">
            ...
            <div class="main-body ui segment">
              ...
              <span class="tut-btn"><Link to="/tutorials/Chapter24">
