...
const Quiz30 = () => {
  ...
  const questions = [
    {
      id: 1,
      question: 'Exceptions are used to handle :',
      options: [
        "errors", "exceptions",  "Both A and B", "none"
      ],
      correctAnswer: "Both A and B",
    },
    {
      id: 2,
      question: 'Identify the syntax of exception :',
      options: [
        "try{ throw exception; }catch(){}", "try{ }catch(){}", "try{ throw exception; }", "none" 
      ],
      correctAnswer: "try{ throw exception; }catch(){}",
    },
    {
      id: 3,
      question: 'Code of catch block is executed when:',
      options: ["exception occurs", "always", "never", "depends upon code"],
      correctAnswer: "exception occurs",
    },
        ...
        <div class="container">
          <div className="ch-content">
            ...
            <div class="main-body ui segment">
              ...
              <span class="tut-btn"><Link to="/tutorials/Chapter28">
